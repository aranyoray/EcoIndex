# 🌊 EcoIndex - Water Quality & Greenspace Analysis
...
![EcoIndex](https://img.shields.io/badge/EcoIndex-Water%20Quality%20%26%20Greenspace-blue?style=for-the-badge)
...
Then open `http://localhost:8000/eco-destination.html` in your browser.

## 📁 Project Structure

```
EcoIndex/
├── eco-destination.html      # Main application interface
...
├── ai-predictions.js         # AI prediction models (TensorFlow.js)
├── eco-map.js                # Main map visualization controller
├── README.md                 # This file
└── README_ECO.md             # Detailed documentation
```
...
- **Chart.js**: Data visualization and comparison charts
- **TensorFlow.js**: Machine learning predictions

All dependencies are loaded via CDN - no package installation required!
